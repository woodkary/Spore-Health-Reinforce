...
public class SporeAxeItems extends SporeDiggerTools {
   ...
   public InteractionResult useOn(UseOnContext context) {
      ...
      if (optional3.isPresent()) {
         ...
         level.gameEvent(GameEvent.BLOCK_CHANGE, blockpos, Context.of(player, (BlockState)optional3.get()));
         if (player != null) {
   ...
   private Optional getStripped(BlockState p_150691_) {
      return Optional.ofNullable((Block)STRIPPABLES.get(p_150691_.getBlock())).map((p_150689_) -> (BlockState)p_150689_.defaultBlockState().setValue(RotatedPillarBlock.AXIS, (Direction.Axis)p_150691_.getValue(RotatedPillarBlock.AXIS)));
   }
