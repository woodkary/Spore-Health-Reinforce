...
public class InfectedExoskeleton extends SporeBaseArmor implements CustomModelArmorData {
   ...
   public InfectedExoskeleton(Type type) {
      super(type, new int[]{(Integer)SConfig.SERVER.boots_durability.get(), (Integer)SConfig.SERVER.pants_durability.get(), (Integer)SConfig.SERVER.chestplate_durability.get(), (Integer)SConfig.SERVER.helmet_durability.get()}, new int[]{(Integer)SConfig.SERVER.boots_protection.get(), (Integer)SConfig.SERVER.pants_protection.get(), (Integer)SConfig.SERVER.chestplate_protection.get(), (Integer)SConfig.SERVER.helmet_protection.get()}, (float)(Integer)SConfig.SERVER.armor_toughness.get(), (float)(Integer)SConfig.SERVER.knockback_resistance.get(), (SoundEvent)Ssounds.INFECTED_GEAR_EQUIP.get(), "Infected");
   }
