...
public class InfectedCombatShovel extends SporeDiggerTools {
   ...
   public InfectedCombatShovel() {
      super((double)(Integer)SConfig.SERVER.shovel_damage.get(), (double)3.0F, (double)2.0F, (Integer)SConfig.SERVER.shovel_durability.get(), 5, "shovel", BlockTags.MINEABLE_WITH_SHOVEL);
   }
