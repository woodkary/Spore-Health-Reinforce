...
public class HiveTumorMembraneLayer extends TranslucentLayer<HiveTumor> {
   private static final ResourceLocation SYRINGE = new ResourceLocation("spore", "textures/entity/eyes/hivetumor_membrane.png");

   public HiveTumorMembraneLayer(RenderLayerParent p_117346_) {
      super(p_117346_);
   }
