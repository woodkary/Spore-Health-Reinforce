...
public class ProtoMembraneLayer extends TranslucentLayer<Proto> {
   private static final ResourceLocation SYRINGE = new ResourceLocation("spore", "textures/entity/eyes/proto_membrane.png");

   public ProtoMembraneLayer(RenderLayerParent p_117346_) {
      super(p_117346_);
   }
