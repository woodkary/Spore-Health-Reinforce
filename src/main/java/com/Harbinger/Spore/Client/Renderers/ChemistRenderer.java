...
public class ChemistRenderer extends MobRenderer<Chemist, EntityModel<Chemist>> {
   public static final ResourceLocation TEXTURE = new ResourceLocation("spore", "textures/entity/chemist.png");
   ...
   public ChemistRenderer(EntityRendererProvider.Context context) {
      ...
      this.addLayer(new ChemistGlassRenderer(this));
   }
   ...
   private static class ChemistGlassRenderer extends TranslucentLayer<Chemist> {
      private static final ResourceLocation TEXTURE = new ResourceLocation("spore", "textures/entity/eyes/chemist.png");

      public ChemistGlassRenderer(RenderLayerParent p_117346_) {
         super(p_117346_);
      }
