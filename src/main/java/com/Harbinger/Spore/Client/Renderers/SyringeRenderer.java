...
public class SyringeRenderer extends EntityRenderer<SyringeProjectile> {
   public static final ResourceLocation LOCATION = new ResourceLocation("spore", "textures/entity/syringe.png");
   private final SyringeProjectileModel model = new SyringeProjectileModel();
   ...
   public void render(SyringeProjectile spear, float p_116112_, float p_116113_, PoseStack stack, MultiBufferSource source, int p_116116_) {
      ...
      VertexConsumer vertexconsumer = source.getBuffer(RenderType.entityTranslucent(this.getTextureLocation(spear)));
