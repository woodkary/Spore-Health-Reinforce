...
public class MistmakerPartRight extends BaseArmorRenderingBit {
   public MistmakerPartRight(Supplier model, Supplier part, float x, float y, float z, float expand) {
      super(EquipmentSlot.MAINHAND, (Item)Sitems.MISTMAKER.get(), model, part, x, y, z, expand);
   }
