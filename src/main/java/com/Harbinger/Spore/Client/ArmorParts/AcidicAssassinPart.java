...
public class AcidicAssassinPart extends ComplexHandModelItem {
   public AcidicAssassinPart(InteractionHand slot, AcidicAssasinModel model, ModelPart part, float x, float y, float z, float expand, float xspin, float yspin, float zspin) {
      super(slot, (Item)Sitems.ACIDIC_ASSASSIN.get(), model, part, x, y, z, expand, xspin, yspin, zspin);
   }
