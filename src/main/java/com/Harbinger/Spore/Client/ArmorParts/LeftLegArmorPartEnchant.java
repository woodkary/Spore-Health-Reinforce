...
public class LeftLegArmorPartEnchant extends BaseArmorRenderingBit implements EnchantingPart {
   ...
   public LeftLegArmorPartEnchant(Supplier model, Supplier part, float x, float y, float z, float expand, Enchantment enchantment, ResourceLocation location, List blacklist) {
