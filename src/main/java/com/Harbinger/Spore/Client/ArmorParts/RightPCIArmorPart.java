...
public class RightPCIArmorPart extends BaseArmorRenderingBit {
   ...
   public RightPCIArmorPart(Supplier model, Supplier part, ResourceLocation location) {
      super(EquipmentSlot.MAINHAND, (Item)Sitems.PCI.get(), model, part, -0.15F, -0.35F, -0.05F, 1.0F);
