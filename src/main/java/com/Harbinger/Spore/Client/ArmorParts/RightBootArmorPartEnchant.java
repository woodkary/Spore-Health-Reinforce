...
public class RightBootArmorPartEnchant extends BaseArmorRenderingBit implements EnchantingPart {
   ...
   public RightBootArmorPartEnchant(Supplier model, Supplier part, float x, float y, float z, float expand, Enchantment enchantment, ResourceLocation location, List blacklist) {
      super(EquipmentSlot.FEET, (Item)null, model, part, x, y, z, expand);
