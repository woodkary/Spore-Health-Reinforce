...
public class LivingHorseArmorBit extends HorseArmorBit {
   private final LivingHorseArmorModel platedHorseArmorModel = new LivingHorseArmorModel();
   ...
   public EntityModel getModel() {
      return this.platedHorseArmorModel;
   }
      ...
      if (!itemStack.isEmpty()) {
         ...
         if (item instanceof CustomModelArmorData) {
            ...
            if (itemStack.getItem().equals(this.item)) {
               ...
               ModelPart head = this.platedHorseArmorModel.Neck;
               ModelPart body = this.platedHorseArmorModel.Body;
               ModelPart rightFront = this.platedHorseArmorModel.FrontRightLeg;
               ModelPart leftFront = this.platedHorseArmorModel.FrontLeftLeg;
               ModelPart rightBack = this.platedHorseArmorModel.BackRightLeg;
               ModelPart leftBack = this.platedHorseArmorModel.BackLeftLeg;
