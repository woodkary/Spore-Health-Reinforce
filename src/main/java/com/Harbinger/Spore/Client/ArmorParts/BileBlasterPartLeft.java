...
public class BileBlasterPartLeft extends BaseArmorRenderingBit {
   public BileBlasterPartLeft(Supplier model, Supplier part, float x, float y, float z, float expand) {
      super(EquipmentSlot.OFFHAND, (Item)Sitems.BILE_BLASTER.get(), model, part, x, y, z, expand);
   }
