...
public class AcidicAssassinPartRight extends BaseArmorRenderingBit {
   public AcidicAssassinPartRight(Supplier model, Supplier part, float x, float y, float z, float expand) {
      super(EquipmentSlot.MAINHAND, (Item)Sitems.ACIDIC_ASSASSIN.get(), model, part, x, y, z, expand);
   }
