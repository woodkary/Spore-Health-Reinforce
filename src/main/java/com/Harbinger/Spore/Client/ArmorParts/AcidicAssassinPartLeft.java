...
public class AcidicAssassinPartLeft extends BaseArmorRenderingBit {
   public AcidicAssassinPartLeft(Supplier model, Supplier part, float x, float y, float z, float expand) {
      super(EquipmentSlot.OFFHAND, (Item)Sitems.ACIDIC_ASSASSIN.get(), model, part, x, y, z, expand);
   }
