...
public abstract class HorseArmorBit {
   ...
   protected VertexConsumer consumer(MultiBufferSource source, CustomModelArmorData data, CustomHorseArmorLayer.HorseHandlerModel model, AbstractHorse livingEntity) {
