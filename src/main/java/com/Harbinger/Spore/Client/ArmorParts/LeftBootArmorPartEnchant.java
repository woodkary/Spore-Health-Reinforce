...
public class LeftBootArmorPartEnchant extends BaseArmorRenderingBit implements EnchantingPart {
   ...
   public LeftBootArmorPartEnchant(Supplier model, Supplier part, float x, float y, float z, float expand, Enchantment enchantment, ResourceLocation location, List blacklist) {
