...
public class SyringeGunArmorPartRight extends BaseArmorRenderingBit {
   ...
   public SyringeGunArmorPartRight(SyringeGunModelArm parentModel, Supplier model, Supplier part, float x, float y, float z, float expand) {
      super(EquipmentSlot.MAINHAND, (Item)Sitems.SYRINGE_GUN.get(), model, part, x, y, z, expand);
