...
public class InfectedModel extends EntityModel<InfectedHuman> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "infectedmodel"), "main");
   ...
   public void setupAnim(InfectedHuman entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
