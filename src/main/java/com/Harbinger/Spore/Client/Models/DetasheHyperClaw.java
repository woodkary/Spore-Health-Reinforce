...
public class DetasheHyperClaw extends HierarchicalModel<HyperClaw> implements TentacledModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "detashehyperclaw"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      RASplit1Plane.addOrReplaceChild("Plane_r1", CubeListBuilder.create().texOffs(38, 7).addBox(0.0F, -3.5F, -1.5F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 0.5F, 0.0F, 3.1416F, 0.0F));
      ...
      RASplit2Plane1.addOrReplaceChild("Plane_r2", CubeListBuilder.create().texOffs(60, -4).mirror().addBox(0.0F, -3.5F, -2.0F, 0.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.0F, -0.5F, 0.0F, 3.1416F, 0.0F));
   ...
   public void setupAnim(HyperClaw entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      this.root().getAllParts().forEach(ModelPart::resetPose);
      this.animateTentacleY(this.RMClaw1, netHeadYaw / (180F / (float)Math.PI));
      this.animateTentacleX(this.RMJoint1, Mth.cos(ageInTicks / 6.0F) / 6.0F);
      this.animateTentacleZ(this.RAClaw3, Mth.cos(ageInTicks / 6.0F) / 6.0F);
      this.animateTentacleZ(this.RAClaw4, -Mth.cos(ageInTicks / 6.0F) / 6.0F);
      this.animateTentacleX(this.RAJoint3, Mth.cos(ageInTicks / 6.0F) / 6.0F);
      this.animateTentacleX(this.RAJoint4, -Mth.cos(ageInTicks / 6.0F) / 6.0F);
      this.animateWalk(HyperClawAnimations.RUN, limbSwing, limbSwingAmount, 2.0F, 3.0F);
   }
}
