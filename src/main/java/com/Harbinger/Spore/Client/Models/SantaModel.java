...
public class SantaModel extends EntityModel<Sieger> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "santamodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      HatSeg4.addOrReplaceChild("HatSeg4_r1", CubeListBuilder.create().texOffs(400, 0).addBox(-5.0F, -4.5F, -3.25F, 10.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.0469F, 0.0F));
      ...
      HatSeg5.addOrReplaceChild("HatSeg5_r1", CubeListBuilder.create().texOffs(392, 22).addBox(-4.0F, -0.5F, -2.25F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.0469F, 0.0F));
      PartDefinition HatKnob = HatSeg5.addOrReplaceChild("HatKnob", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      HatKnob.addOrReplaceChild("Puff_r1", CubeListBuilder.create().texOffs(392, 37).addBox(-5.0F, -10.5F, -3.5F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.0469F, 0.0F));
   ...
   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      this.SantaHat.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
   }
}
