...
public class ElytrumModel extends EntityModel<LivingEntity> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      left_wing.addOrReplaceChild("left_for_wing", CubeListBuilder.create().texOffs(47, 110).addBox(-12.25F, -5.0F, 0.0F, 17.0F, 18.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 12.0F, -1.0F));
      ...
      right_wing.addOrReplaceChild("right_for_wing", CubeListBuilder.create().texOffs(1, 110).addBox(-4.25F, -5.0F, 0.06F, 17.0F, 18.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.5F, 12.0F, -1.0F));
