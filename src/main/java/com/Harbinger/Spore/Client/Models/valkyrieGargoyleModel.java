...
public class valkyrieGargoyleModel extends EntityModel<Gargoyl> implements TentacledModel, GargoyleBits {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "valkyriegargoylemodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      BottomArmBase.addOrReplaceChild("Claw_r1", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 1.5F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.7F, 3.0F, -2.0F, 3.1416F, 0.0F, 2.9147F));
      BottomArmBase.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(31, 81).addBox(-4.0F, -2.0F, -1.0F, 5.0F, 13.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.1F, 0.05F, -5.7F, -3.0015F, -0.1137F, 2.905F));
      BottomArmBase.addOrReplaceChild("Claw_r2", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.6F, 2.2F, -5.9F, -2.9277F, -0.6699F, 2.7178F));
      BottomArmBase.addOrReplaceChild("Claw_r3", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.6F, 2.8F, -2.0F, 3.0105F, 0.454F, 2.7622F));
      ...
      ValkyrieSwordExtension.addOrReplaceChild("Claw_r4", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, 1.15F, -2.6F, -0.2711F, -0.5761F, 0.1405F));
      ValkyrieSwordExtension.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(73, 78).addBox(-5.0F, 1.0F, 1.0F, 4.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9F, -13.6F, -2.1F, 0.0F, 0.0F, -0.4102F));
      PartDefinition Mass = ValkyrieSwordExtension.addOrReplaceChild("Mass", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      Mass.addOrReplaceChild("Tumour_r1", CubeListBuilder.create().texOffs(42, 85).addBox(-1.0F, -3.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3F, 0.2F, -1.5F, 0.1571F, 0.1571F, 0.0873F));
      Mass.addOrReplaceChild("Tumour_r2", CubeListBuilder.create().texOffs(42, 85).addBox(-1.0F, -3.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2F, -0.4F, -1.9F, 0.1384F, -0.2856F, -0.3563F));
      Mass.addOrReplaceChild("Tumour_r3", CubeListBuilder.create().texOffs(42, 85).addBox(-1.0F, -3.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-1.6F, -1.4F, -0.4F, 0.2682F, 0.2224F, 0.1147F));
      Mass.addOrReplaceChild("Tumour_r4", CubeListBuilder.create().texOffs(42, 85).addBox(-1.0F, -3.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1002F, 0.19F, -0.3698F));
      ...
      BoneBlade.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(58, 78).addBox(-6.0F, 1.0F, 1.0F, 5.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3F, -4.4F, -1.3F, 0.0F, 0.0F, -0.2007F));
   ...
   public void setupAnim(Gargoyl entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float aggressive = entity.isAggressive() ? -90.0F : 0.0F;
      this.animateTentacleX(this.RightArm, -bodyAngle + defVal + aggressive);
      this.animateTentacleX(this.LeftArm, -bodyAngle + defVal + aggressive);
      ...
      this.animateTentacleZ(this.BoneBlade, defValT2);
