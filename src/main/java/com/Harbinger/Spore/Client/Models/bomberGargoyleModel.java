...
public class bomberGargoyleModel extends EntityModel<Gargoyl> implements TentacledModel, GargoyleBits {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "bombergargoylemodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      Stomach.addOrReplaceChild("Foliage_r7", CubeListBuilder.create().texOffs(-6, 101).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.2789F, -2.9986F, -1.0F, 2.4024F, -1.4251F, -2.4531F));
      ...
      Head.addOrReplaceChild("Foliage3_r1", CubeListBuilder.create().texOffs(-6, 107).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5624F, -4.9673F, -6.9211F, -1.4201F, 1.3088F, -1.5463F));
      ...
      MadcapHeadTumors.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(238, 3).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.3279F, 1.6307F, 4.285F, 2.2846F, -1.2183F, -2.127F));
      ...
      tumorHead.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(236, 2).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1065F, 2.6581F, 1.6146F, 0.2735F, -0.7218F, -0.3492F));
      tumorHead.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(232, 0).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.13F, -1.5772F, -2.068F, 0.192F, 0.1745F, -0.1396F));
      ...
      tumorHead2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(236, 2).addBox(-2.0F, -1.5F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6126F, 1.1752F, -2.7868F, 1.8524F, -1.3581F, -2.0244F));
      tumorHead2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(234, 1).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9618F, -4.0096F, -2.6767F, 0.8663F, -1.2385F, -0.4967F));
      tumorHead2.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(232, 0).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.27F, -2.8772F, 1.632F, -0.8175F, 0.1671F, -0.0016F));
      ...
      MadcapBottomTumors.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(236, 2).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.146F, -2.3332F, 3.3768F, 2.9691F, 0.6202F, -1.8419F));
      MadcapBottomTumors.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(238, 3).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7065F, -1.4215F, -3.4989F, 2.8832F, 0.098F, -1.2593F));
      MadcapBottomTumors.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(236, 2).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.546F, 0.8668F, -1.7233F, -2.9042F, -0.1172F, -1.6749F));
      MadcapBottomTumors.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(236, 2).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.746F, 1.9668F, 0.4768F, -3.1076F, 0.3546F, -2.4762F));
      MadcapBottomTumors.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(236, 2).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.154F, 3.1668F, -0.1233F, -2.668F, -0.232F, -2.942F));
      MadcapBottomTumors.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(232, 0).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.4388F, -1.1229F, 0.746F, -1.8482F, -1.3564F, 2.1034F));
      MadcapBottomTumors.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(232, 0).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.8612F, -1.1229F, 0.746F, -0.3938F, -1.1747F, 0.0861F));
   ...
   public void setupAnim(Gargoyl entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.Head.xRot = headPitch / 28.647888F - bodyAngle * 2.0F;
      ...
      this.animateTumor(this.tumorHead, Mth.sin(ageInTicks / 9.0F) / 10.0F);
      this.animateTumor(this.tumorHead2, Mth.cos(ageInTicks / 8.0F) / 12.0F);
      this.animateTumor(this.MadcapBottomTumors, defValT4);
