...
public class InfEvoClawModel extends EntityModel<InfEvoClaw> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "infevoclawmodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      base.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(10, 9).addBox(-1.5F, -6.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
      ...
      middleF2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(12, 18).addBox(-1.0F, -5.75F, -1.25F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3054F, 0.0F, 0.0F));
      PartDefinition middleF3 = middleF2.addOrReplaceChild("middleF3", CubeListBuilder.create(), PartPose.offset(0.0F, -6.0F, -2.0F));
      middleF3.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 20).addBox(0.0F, -5.75F, -1.25F, 0.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3054F, 0.0F, 0.0F));
      ...
      jointG.addOrReplaceChild("claw", CubeListBuilder.create().texOffs(8, 25).addBox(0.0F, -6.0F, -1.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
      ...
      jointG2.addOrReplaceChild("claw2", CubeListBuilder.create().texOffs(22, 22).addBox(0.0F, -6.0F, -1.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
      ...
      jointG3.addOrReplaceChild("claw3", CubeListBuilder.create().texOffs(22, 15).addBox(0.0F, -6.0F, -1.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
      ...
      jointG4.addOrReplaceChild("claw4", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -7.0F, -2.0F, 0.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
      return LayerDefinition.create(meshdefinition, 64, 64);
   }

   public void setupAnim(InfEvoClaw entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      this.baseJoint.getChild("base").getChild("middleF").xRot = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("middleF").getChild("middleF2").xRot = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("middleF").getChild("middleF2").getChild("middleF3").xRot = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT").yRot = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT2").yRot = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT3").yRot = -Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT4").yRot = -Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT").zRot = -Mth.sin(ageInTicks / 8.0F) / 8.0F;
      this.baseJoint.getChild("base").getChild("fingerT2").zRot = -Mth.sin(ageInTicks / 8.0F) / 7.0F;
      this.baseJoint.getChild("base").getChild("fingerT3").zRot = Mth.sin(ageInTicks / 8.0F) / 9.0F;
      this.baseJoint.getChild("base").getChild("fingerT4").zRot = -Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT").getChild("jointT").getChild("fingerG").yRot = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT2").getChild("jointT2").getChild("fingerG2").yRot = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT3").getChild("jointT3").getChild("fingerG3").yRot = -Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.baseJoint.getChild("base").getChild("fingerT4").getChild("jointT4").getChild("fingerG4").yRot = -Mth.sin(ageInTicks / 8.0F) / 6.0F;
   }

   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      this.baseJoint.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
   }
}
