...
public class InfectedPillagerModel extends EntityModel<InfectedPillager> implements ArmedModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "infectedpillagermodel"), "main");
