...
public class InfectedPlayerModel extends HumanoidModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "infectedplayermodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(24, 0).addBox(-4.0F, -0.25F, -3.25F, 8.0F, 2.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, -1.75F, -0.75F));
      ...
      partdefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(64, 19).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)), PartPose.offset(0.0F, 0.0F, 0.0F));
   ...
   public void setupAnim(InfectedPlayer entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.jaw.xRot = Mth.sin(ageInTicks / 6.0F) / 7.0F;
   }
