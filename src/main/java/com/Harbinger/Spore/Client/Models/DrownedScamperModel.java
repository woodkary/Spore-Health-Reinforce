...
public class DrownedScamperModel extends EntityModel<Scamper> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "drownedscampermodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      Fin.addOrReplaceChild("Fin_r1", CubeListBuilder.create().texOffs(0, 86).addBox(-0.01F, -3.6955F, -9.5307F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 8.0F, -0.3927F, 0.0F, 0.0F));
      ...
      RightLeg.addOrReplaceChild("rightForLeg", CubeListBuilder.create().texOffs(52, 39).addBox(-1.75F, 0.0F, -1.75F, 3.0F, 6.0F, 3.5F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 4.0F, 0.0F));
      ...
      LeftArm.addOrReplaceChild("Plane_r1", CubeListBuilder.create().texOffs(4, 88).addBox(-3.0F, -3.0F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, 1.25F, 4.0F, 0.0F, -1.5708F, 0.0F));
      PartDefinition LeftForArm = LeftArm.addOrReplaceChild("LeftForArm", CubeListBuilder.create(), PartPose.offset(0.0F, 4.0F, 0.0F));
      LeftForArm.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(40, 59).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0873F, 0.0F, 0.0F));
      ...
      RightArm.addOrReplaceChild("Plane_r2", CubeListBuilder.create().texOffs(4, 88).addBox(-3.0F, -3.0F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, 1.25F, 4.0F, 0.0F, -1.5708F, 0.0F));
      ...
      head.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(57, 61).addBox(-6.0475F, -1.0863F, -1.3418F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.5F, 2.5F, 0.0436F, -0.3491F, -0.2618F));
      head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(58, 61).addBox(-4.0F, -24.0F, -4.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 19.5F, 2.5F, -0.0873F, 1.0036F, 0.1309F));
   ...
   public void setupAnim(Scamper entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (entity.isInFluidType()) {
         this.Fin.yRot = Mth.sin(ageInTicks / 6.0F) / 6.0F;
      }
   ...
   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      ...
      this.Fin.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
