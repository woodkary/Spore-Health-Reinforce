...
public class InfectedWandererModel extends EntityModel<InfectedWanderingTrader> implements ArmedModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "infectedvillagermodel"), "main");
   ...
   public void setupAnim(InfectedWanderingTrader entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
