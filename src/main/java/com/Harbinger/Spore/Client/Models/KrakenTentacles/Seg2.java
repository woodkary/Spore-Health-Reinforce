...
public class Seg2 extends EntityModel<Entity> implements TentacledModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "seg2"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      Corpse1.addOrReplaceChild("Head_r1", CubeListBuilder.create().texOffs(32, 65).addBox(-3.0F, -6.5F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.9143F, 1.0714F, -1.5708F, 1.1694F, -1.5708F));
      ...
      Corpse2.addOrReplaceChild("Head_r2", CubeListBuilder.create().texOffs(32, 65).addBox(-3.0F, -6.5F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 0.6F, -1.5708F, 1.4835F, -1.5708F));
   ...
   public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      this.animateTentacleZ(this.Tendril1, Mth.sin(ageInTicks / 6.0F) / 6.0F);
      this.animateTentacleX(this.Tendril2, Mth.cos(ageInTicks / 7.0F) / 7.0F);
      this.animateTentacleY(this.Tendril3, Mth.sin(ageInTicks / 9.0F) / 4.0F);
   }
