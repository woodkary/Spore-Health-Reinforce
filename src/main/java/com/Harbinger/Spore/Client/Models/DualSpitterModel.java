...
public class DualSpitterModel extends EntityModel<Spitter> implements TentacledModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "dualspittermodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      thisdoesntmakesense.addOrReplaceChild("bodywear", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, 9.0F, -3.25F, 8.0F, 9.0F, 6.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(0.0F, -24.0F, -0.25F, 0.0436F, 0.0F, 0.0F));
      ...
      RightLeg.addOrReplaceChild("rightForLeg", CubeListBuilder.create().texOffs(44, 19).addBox(-1.75F, 0.0F, -2.5F, 3.0F, 6.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 6.0F, 0.0F));
      ...
      LeftLeg.addOrReplaceChild("leftForLeg", CubeListBuilder.create().texOffs(38, 40).addBox(-1.25F, 0.0F, -2.5F, 3.0F, 6.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 6.0F, 0.0F));
      ...
      head.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(72, 0).addBox(-6.0F, -34.0F, -12.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 27.0F, 5.0F, -0.1745F, 0.0F, 0.0F));
      head.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(72, 0).addBox(-8.0F, -31.0F, -4.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 27.0F, 5.0F, 0.0495F, 0.045F, 0.258F));
      head.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(25, 61).addBox(-1.0F, -31.0F, -7.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 27.0F, 5.0F, 0.0F, 0.0F, -0.2182F));
      head.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(25, 61).addBox(-6.0F, -34.0F, -15.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 27.0F, 5.0F, -0.2597F, 0.0338F, 0.1265F));
      ...
      nose.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(2, 0).addBox(-0.5F, -1.0F, -3.75F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
      ...
      nose.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(0, 2).addBox(0.0F, -0.75F, -3.85F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 0.5F, 0.0F, 0.5672F, 0.0F, 0.0F));
      ...
      nose.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.1207F, -2.0141F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, -0.25F, -2.0F, 0.9163F, 0.0F, 0.0F));
      ...
      PartDefinition RMJ = RightMandible.addOrReplaceChild("RMJ", CubeListBuilder.create().texOffs(11, 37).addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 7).addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3054F, 0.4363F, 0.0F));
      PartDefinition RightMandible2 = RMJ.addOrReplaceChild("RightMandible2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -6.0F));
      RightMandible2.addOrReplaceChild("RMJ2", CubeListBuilder.create().texOffs(11, 35).addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(46, 0).addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, -0.3927F, 0.0F));
      PartDefinition LeftMandible = neck2.addOrReplaceChild("LeftMandible", CubeListBuilder.create(), PartPose.offset(3.0F, -0.25F, -1.5F));
      PartDefinition LMJ = LeftMandible.addOrReplaceChild("LMJ", CubeListBuilder.create().texOffs(32, 2).mirror().addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(44, 32).mirror().addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3054F, -0.4363F, 0.0F));
      PartDefinition LeftMandible2 = LMJ.addOrReplaceChild("LeftMandible2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -6.0F));
      LeftMandible2.addOrReplaceChild("LMJ2", CubeListBuilder.create().texOffs(28, 17).mirror().addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(38, 1).mirror().addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.3927F, 0.0F));
      ...
      PartDefinition RMJ3 = RightMandible3.addOrReplaceChild("RMJ3", CubeListBuilder.create().texOffs(11, 37).addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 7).addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.0472F, 0.3491F, 1.7453F));
      ...
      RightMandible4.addOrReplaceChild("RMJ4", CubeListBuilder.create().texOffs(11, 35).addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(46, 0).addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, 0.0F, 0.0436F));
      ...
      PartDefinition LMJ3 = LeftMandible3.addOrReplaceChild("LMJ3", CubeListBuilder.create().texOffs(32, 2).mirror().addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(44, 32).mirror().addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -2.0F, 2.0F, 1.0472F, -0.3491F, -1.7453F));
      PartDefinition LeftMandible4 = LMJ3.addOrReplaceChild("LeftMandible4", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -6.0F));
      LeftMandible4.addOrReplaceChild("LMJ4", CubeListBuilder.create().texOffs(28, 17).mirror().addBox(0.0F, -2.5F, -6.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(38, 1).mirror().addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, 0.0F, -0.0436F));
      ...
      right_mutated_tube4.addOrReplaceChild("right_mutated_tube5", CubeListBuilder.create().texOffs(52, 30).addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(49, 39).addBox(-3.0F, -3.0F, -2.55F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, -0.3491F, 0.0F, 0.0F));
      ...
      left_mutated_tube4.addOrReplaceChild("left_mutated_tube5", CubeListBuilder.create().texOffs(52, 30).addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(49, 39).addBox(-3.0F, -3.0F, -2.55F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, -0.3491F, 0.0F, 0.0F));
   ...
   public void setupAnim(Spitter entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.left_mutated_tube.xRot = Mth.sin(ageInTicks / 8.0F) / 10.0F;
      this.right_mutated_tube.xRot = Mth.sin(ageInTicks / 8.0F) / 10.0F;
   ...
   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      this.thisdoesntmakesense.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
   }
}
