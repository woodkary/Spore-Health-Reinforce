...
public class InfectedVindicatorModel extends EntityModel<InfectedVendicator> implements ArmedModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "infectedvindicatormodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition armthing = RightArm.addOrReplaceChild("armthing", CubeListBuilder.create().texOffs(30, 52).addBox(-1.0F, -4.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(22, 0).addBox(-0.5F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.05F)).texOffs(56, 9).addBox(-3.0F, -9.0F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 2.0F, 0.0F));
      armthing.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -4.0F, 0.0F, 3.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 1.0F, 0.0F, 0.3491F, 0.0F));
      armthing.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 29).addBox(-2.0F, -4.0F, 0.0F, 3.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -1.0F, 0.0F, -0.3491F, 0.0F));
      ...
      LeftForArm.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(44, 52).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0873F, 0.0F, 0.0F));
   ...
   public void setupAnim(InfectedVendicator entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      if (entity.isAggressive()) {
         this.head.getChild("jaw").xRot = Mth.sin(ageInTicks / 6.0F) / 10.0F + 0.4F;
         this.RightArm.xRot = -90.0F - Mth.sin(ageInTicks / 4.0F) / 7.0F;
         this.LeftArm.xRot = -90.0F + Mth.sin(ageInTicks / 4.0F) / 7.0F;
         if (entity.swinging) {
            float j = 0.0F;
            j += 0.5F;
            this.RightArm.xRot = -90.0F + j;
         ...
         if (Mth.sin(ageInTicks / 8.0F) / 10.0F <= 0.0F) {
            this.RightArm.getChild("RightForArm").xRot = Mth.sin(ageInTicks / 8.0F) / 10.0F;
         }
      } else {
