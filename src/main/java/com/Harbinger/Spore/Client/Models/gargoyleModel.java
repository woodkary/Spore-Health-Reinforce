...
public class gargoyleModel extends EntityModel<Gargoyl> implements TentacledModel, GargoyleBits {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "gargoylemodel"), "main");
