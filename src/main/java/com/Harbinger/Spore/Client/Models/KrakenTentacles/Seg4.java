...
public class Seg4 extends EntityModel<Entity> implements TentacledModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "seg4"), "main");
   ...
   public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      this.animateTentacleZ(this.Tendril1, Mth.sin(ageInTicks / 7.0F) / 6.0F);
      this.animateTentacleZ(this.Tendril3, Mth.cos(ageInTicks / 5.0F) / 6.0F);
      this.animateTentacleY(this.Fin, Mth.cos(ageInTicks / 8.0F) / 8.0F);
   }
