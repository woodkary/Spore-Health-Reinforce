...
public class bloomingGargoyleModel extends EntityModel<Gargoyl> implements TentacledModel, GargoyleBits {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "bloominggargoylemodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal5_r1", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.65F, 0.975F, -2.775F, 2.8835F, -0.4364F, -1.7982F));
      StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal4_r1", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.35F, 2.975F, -1.975F, 3.0336F, 0.4746F, 3.029F));
      StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal3_r1", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.85F, -0.025F, 1.325F, 1.6058F, 0.4193F, 1.2004F));
      StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal2_r1", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.85F, -1.925F, 1.425F, 1.404F, -0.5977F, -0.0592F));
      ...
      TumorCluster8.addOrReplaceChild("Tumor_r2", CubeListBuilder.create().texOffs(52, 71).addBox(-1.0F, -4.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1325F, -0.4365F, 2.4059F, 1.163F, 0.7706F, -1.0506F));
      TumorCluster8.addOrReplaceChild("Tumor_r3", CubeListBuilder.create().texOffs(54, 71).addBox(-1.0F, -4.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1325F, -3.4365F, 1.4059F, 0.8355F, -0.8479F, 2.5215F));
      ...
      Head.addOrReplaceChild("Foliage3_r1", CubeListBuilder.create().texOffs(-6, 107).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.6624F, -4.9673F, -6.0211F, -1.4201F, 1.3088F, -1.5463F));
      ...
      HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal4_r2", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.65F, -0.025F, -1.775F, 2.5781F, -0.4364F, -1.7982F));
      HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal3_r2", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.35F, 1.975F, -0.975F, 2.4227F, 0.4746F, 3.029F));
      HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal2_r2", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.85F, -0.025F, 1.325F, 1.5078F, 0.4065F, 1.3905F));
      HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal1_r1", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.85F, -1.925F, 1.425F, 1.2151F, -0.5845F, 0.0447F));
      ...
      TopArmBase.addOrReplaceChild("Foliage_r7", CubeListBuilder.create().texOffs(-6, 107).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.7211F, -9.9986F, -4.0F, 2.7477F, 0.7821F, 2.7358F));
      TopArmBase.addOrReplaceChild("Foliage_r8", CubeListBuilder.create().texOffs(-6, 113).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.7211F, -7.9986F, 0.0F, 2.6259F, -1.1793F, -2.7677F));
      ...
      BottomArmBase.addOrReplaceChild("Foliage_r9", CubeListBuilder.create().texOffs(-7, 107).addBox(-5.0F, 0.0F, -3.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.7211F, -2.9986F, -3.0F, 0.8173F, -0.9118F, -0.9529F));
      BottomArmBase.addOrReplaceChild("Claw_r1", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 1.5F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(22, 93).addBox(-3.2834F, -3.091F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 4.0F, -2.0F, 3.1416F, 0.0F, 3.0543F));
      BottomArmBase.addOrReplaceChild("Claw_r2", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 4.0F, -5.0F, 3.1416F, 0.0F, 3.0543F));
      ...
      TumorCluster6.addOrReplaceChild("Tumor_r4", CubeListBuilder.create().texOffs(37, 69).addBox(-1.0F, -3.0F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0466F, -0.4033F, 0.6459F, -0.5533F, 0.2768F, -1.0254F));
      TumorCluster6.addOrReplaceChild("Tumor_r5", CubeListBuilder.create().texOffs(37, 69).addBox(-1.0F, -3.0F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0466F, 1.5967F, 2.6459F, 0.8603F, 0.09F, 2.5534F));
      TumorCluster6.addOrReplaceChild("Tumor_r6", CubeListBuilder.create().texOffs(35, 68).addBox(-2.0F, -3.0F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.9534F, -0.4033F, 0.6459F, 1.7455F, -0.043F, -1.5784F));
      ...
      TopArmBase2.addOrReplaceChild("Foliage_r10", CubeListBuilder.create().texOffs(-7, 101).addBox(-5.0F, 0.0F, -3.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, -1.0F, -3.0F, -0.1948F, 0.3292F, 0.3908F));
      TopArmBase2.addOrReplaceChild("Foliage_r11", CubeListBuilder.create().texOffs(-7, 107).addBox(-5.0F, 0.0F, -3.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, -7.0F, -6.0F, 0.2427F, 0.0992F, -0.3806F));
      ...
      TumorCluster5.addOrReplaceChild("Tumor_r7", CubeListBuilder.create().texOffs(37, 70).addBox(-3.0F, -2.0F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.939F, 0.8779F, 2.1495F, 0.0F, -0.5236F, -0.6109F));
      ...
      BottomArmBase2.addOrReplaceChild("claw3_r1", CubeListBuilder.create().texOffs(22, 93).addBox(-1.7F, -4.0F, 1.5F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(22, 93).addBox(-1.7F, -4.0F, 3.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(22, 93).addBox(-1.7F, -4.0F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 5.0F, -5.0F, 0.0F, 0.0F, -0.0873F));
      ...
      LeftLeg.addOrReplaceChild("foliage_r12", CubeListBuilder.create().texOffs(-6, 113).addBox(-1.0F, 0.0F, -1.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0208F, 0.4245F, -0.4932F, -0.3491F, 0.0F, 0.0F));
      ...
      BerryBush1.addOrReplaceChild("BB2_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 6.0F, 1.5F, 0.0F, -0.6109F, 0.0F));
      BerryBush1.addOrReplaceChild("BB1_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 6.0F, 1.5F, 0.0F, 0.7418F, 0.0F));
      ...
      GlowBerryCluster.addOrReplaceChild("Berry3_r1", CubeListBuilder.create().texOffs(37, 78).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.683F, 1.3819F, 1.6065F, 0.2249F, -0.7318F, 0.4321F));
      GlowBerryCluster.addOrReplaceChild("Berry2_r1", CubeListBuilder.create().texOffs(37, 79).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.683F, -0.6181F, 1.6065F, 0.9667F, -0.7318F, 0.4321F));
      GlowBerryCluster.addOrReplaceChild("Berry1_r1", CubeListBuilder.create().texOffs(35, 77).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.317F, 1.3819F, -1.3935F, 0.9667F, -0.7318F, 0.4321F));
      ...
      BerryBush2.addOrReplaceChild("BB4_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, -0.6109F, 0.0F));
      BerryBush2.addOrReplaceChild("BB3_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, 0.7418F, 0.0F));
      ...
      GlowBerryCluster2.addOrReplaceChild("Berry6_r1", CubeListBuilder.create().texOffs(38, 79).addBox(-1.0F, -2.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8161F, -0.622F, -0.3398F, 0.9189F, -0.7218F, -0.4978F));
      GlowBerryCluster2.addOrReplaceChild("Berry5_r1", CubeListBuilder.create().texOffs(37, 79).addBox(-1.0F, -2.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1839F, 0.378F, 0.6602F, 0.7432F, -0.3243F, 1.3099F));
      GlowBerryCluster2.addOrReplaceChild("Berry4_r1", CubeListBuilder.create().texOffs(38, 78).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1839F, 1.378F, 1.6602F, 0.5138F, -1.2265F, 0.0955F));
      ...
      LeftWing.addOrReplaceChild("Foliage_r13", CubeListBuilder.create().texOffs(-6, 101).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7789F, -4.7486F, 1.5F, 3.0183F, -0.7131F, -3.0625F));
