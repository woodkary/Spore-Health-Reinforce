...
public class ScamperVillagerModel extends EntityModel<Scamper> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "scampervillagermodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(31, 13).addBox(-2.0F, -23.0F, 6.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 22.0F, -3.0F, 0.2233F, -0.2129F, -0.0479F));
      ...
      cloths.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(92, 35).addBox(-5.0F, -8.0F, -3.0F, 8.0F, 8.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(1.0F, -2.0F, 0.5F, 0.3491F, 0.0F, 0.0F));
      ...
      LeftForArm.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 57).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0873F, 0.0F, 0.0F));
      ...
      PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(96, 0).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(42, 6).addBox(-4.0F, -2.0F, 0.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(118, 16).addBox(-1.0F, -5.0F, -6.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(74, 1).addBox(-4.0F, -1.92F, -4.0F, 8.0F, 4.0F, 5.0F, new CubeDeformation(0.04F)).texOffs(23, -1).addBox(-4.25F, -3.0F, -4.25F, 8.5F, 1.0F, 4.25F, new CubeDeformation(0.04F)), PartPose.offset(0.0F, 4.5F, -2.5F));
      head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(57, 61).addBox(-4.0F, -26.0F, -1.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 19.5F, 2.5F, 0.0F, 0.0F, -0.1309F));
      head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(58, 61).addBox(-4.0F, -24.0F, -4.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 17.5F, -0.5F, -0.0873F, 0.9163F, 0.2618F));
      head.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(31, 12).addBox(-1.0F, -26.0F, 2.0F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.5F, 2.5F, 0.0436F, 0.0F, 0.0F));
      ...
      flower2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, 0.0F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));
      flower2.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(35, 68).addBox(0.0F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));
      flower2.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, -6.061F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
      flower2.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(35, 68).addBox(-6.061F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
      ...
      flower.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(56, 61).addBox(-5.52F, 0.0F, 0.0F, 9.66F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));
      flower.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(56, 61).addBox(0.0F, 0.0F, -4.14F, 8.28F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.69F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));
      flower.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(56, 61).addBox(-5.52F, 0.0F, -8.28F, 9.66F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
      flower.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(56, 61).addBox(-8.28F, 0.0F, -4.14F, 8.28F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.69F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
      ...
      flower3.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, 0.0F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));
      flower3.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(35, 68).addBox(0.0F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));
      flower3.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, -6.061F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
      flower3.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(35, 68).addBox(-6.061F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
      ...
      body2.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(12, 80).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -13.0F, 0.0F, -0.7854F, 0.0F));
      ...
      body3.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(12, 80).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -13.0F, 0.0F, -0.7854F, 0.0F));
      ...
      body4.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(12, 80).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -13.0F, 0.0F, -0.7854F, 0.0F));
