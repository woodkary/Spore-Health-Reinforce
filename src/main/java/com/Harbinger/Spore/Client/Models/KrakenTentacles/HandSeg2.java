...
public class HandSeg2 extends EntityModel<Entity> implements TentacledModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "handseg2"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      RASplit2Plane1.addOrReplaceChild("Plane_r1", CubeListBuilder.create().texOffs(120, 70).mirror().addBox(0.0F, -3.5F, -2.0F, 0.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.0F, -0.5F, 0.0F, 3.1416F, 0.0F));
      ...
      RASplit2Joint2.addOrReplaceChild("RASplit2Plane2", CubeListBuilder.create().texOffs(122, 78).addBox(0.0F, -6.0F, -2.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.829F, 0.0F, 0.0F));
      ...
      RASplit2Plane3.addOrReplaceChild("Plane_r2", CubeListBuilder.create().texOffs(120, 70).mirror().addBox(0.0F, -3.5F, -2.0F, 0.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.0F, -0.5F, 0.0F, 3.1416F, 0.0F));
      ...
      RASplit2Joint5.addOrReplaceChild("RASplit2Plane5", CubeListBuilder.create().texOffs(122, 78).addBox(0.0F, -6.0F, -2.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.829F, 0.0F, 0.0F));
      ...
      RASplit2Joint4.addOrReplaceChild("RASplit2Plane4", CubeListBuilder.create().texOffs(122, 78).addBox(0.0F, -6.0F, -2.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.829F, 0.0F, 0.0F));
      ...
      RightArmSplit2Seg3.addOrReplaceChild("RightArm_r1", CubeListBuilder.create().texOffs(21, 12).addBox(1.0F, -1.0F, 0.0F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.8F, 0.75F, -1.5F, 0.0F, 0.0F, -0.2618F));
      ...
      RASplit2Joint6.addOrReplaceChild("RASplit2Plane6", CubeListBuilder.create().texOffs(122, 78).addBox(0.0F, -6.0F, -2.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.829F, 0.0F, 0.0F));
      ...
      RASplit2Joint7.addOrReplaceChild("RASplit2Plane7", CubeListBuilder.create().texOffs(122, 78).addBox(0.0F, -6.0F, -2.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.829F, 0.0F, 0.0F));
      PartDefinition Tumor = partdefinition.addOrReplaceChild("Tumor", CubeListBuilder.create(), PartPose.offset(-0.3125F, 11.4F, -0.125F));
      Tumor.addOrReplaceChild("Biomass_r1", CubeListBuilder.create().texOffs(6, 53).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1875F, 2.6F, 2.625F, -0.3537F, -0.5236F, -0.6155F));
      Tumor.addOrReplaceChild("Biomass_r2", CubeListBuilder.create().texOffs(6, 53).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1875F, 3.6F, -3.375F, 0.7808F, -0.5236F, -0.6155F));
      Tumor.addOrReplaceChild("Biomass_r3", CubeListBuilder.create().texOffs(6, 53).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1875F, -2.4F, -3.375F, 0.0873F, 0.0F, -0.1309F));
      Tumor.addOrReplaceChild("Biomass_r4", CubeListBuilder.create().texOffs(4, 52).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.8125F, 1.1F, 4.625F, -0.1893F, 0.4067F, -0.3388F));
      Tumor.addOrReplaceChild("Biomass_r5", CubeListBuilder.create().texOffs(4, 52).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.4125F, -1.9F, 2.025F, -1.0089F, -0.7023F, -0.3863F));
      Tumor.addOrReplaceChild("Biomass_r6", CubeListBuilder.create().texOffs(4, 52).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.8125F, -2.9F, -3.375F, 1.2217F, 0.0F, 0.3927F));
      Tumor.addOrReplaceChild("Biomass_r7", CubeListBuilder.create().texOffs(4, 52).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.8125F, 1.8F, -2.775F, 0.8463F, 0.1758F, 0.195F));
      Tumor.addOrReplaceChild("Biomass_r8", CubeListBuilder.create().texOffs(0, 50).addBox(-3.5F, -3.5F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.2875F, -1.9F, 3.625F, -0.1289F, 0.0227F, 0.1731F));
      return LayerDefinition.create(meshdefinition, 128, 128);
   }

   public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      this.animateTumor(this.Tumor, Mth.sin(ageInTicks / 8.0F) / 8.0F);
      float v1 = Mth.sin(ageInTicks / 6.0F) / 7.0F;
      float v2 = Mth.cos(ageInTicks / 6.0F) / 8.0F;
      float v3 = Mth.cos(ageInTicks / 7.0F) / 6.0F;
      float v4 = Mth.sin(ageInTicks / 8.0F) / 6.0F;
      this.animateTentacleX(this.Finger1, v1);
      this.animateTentacleY(this.Finger2, v2);
      this.animateTentacleY(this.Finger3, v4);
      this.animateTentacleX(this.RASplit2Claw7, v3);
      this.animateTentacleX(this.RASplit2Claw6, v4);
      this.animateTentacleX(this.RASplit2Claw5, v3);
      this.animateTentacleZ(this.RightArmSplit2Seg1, v1);
      this.animateTentacleX(this.RASplit2Claw4, v2);
      this.animateTentacleX(this.RASplit2Claw1, -v3);
      this.animateTentacleX(this.RASplit2Claw2, -v2);
   }

   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float r, float g, float b, float alpha) {
      this.BaseSegment.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
      this.Fingers.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
