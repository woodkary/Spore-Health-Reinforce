...
public class HarbingerModel extends HumanoidModel {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spore", "harbingermodel"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      eye.addOrReplaceChild("pupil", CubeListBuilder.create().texOffs(104, 39).addBox(-2.5F, -1.5086F, -1.3695F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offset(0.7905F, -2.9971F, -3.436F));
      PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(19, 19).addBox(-4.0F, -2.0F, -1.0F, 8.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 34).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(64, 1).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, 0.0F, 0.25F));
   ...
   public void setupAnim(InfectedPlayer entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      super.setupAnim(entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
      this.AnimateEye(entity, this.pupil);
   }

   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float r, float g, float b, float alpha) {
      this.eye.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
      ...
      this.left_arm.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
      this.right_arm.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
      this.left_leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
      this.right_leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
      this.hat.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, alpha);
   }
}
