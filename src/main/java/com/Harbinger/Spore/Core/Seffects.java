...
public class Seffects {
   public static final DeferredRegister MOB_EFFECTS;
   public static final RegistryObject MYCELIUM;
   public static final RegistryObject MADNESS;
   public static final RegistryObject STARVATION;
   public static final RegistryObject UNEASY;
   public static final RegistryObject MARKER;
   public static final RegistryObject CORROSION;
   public static final RegistryObject FROSTBITE;
   public static final RegistryObject BILED;
   public static final RegistryObject SYMBIOSIS;
