...
public class ThrownSpear extends AbstractArrow {
   ...
   public ThrownSpear(Level p_37569_, LivingEntity p_37570_, ItemStack stack, int color) {
      ...
      this.spearItem = new ItemStack((ItemLike)Sitems.INFECTED_SPEAR.get());
   ...
   public ThrownSpear(EntityType thrownSpearEntityType, Level level) {
   ...
   protected void onHitEntity(EntityHitResult hit) {
      ...
      float f = (float)(Integer)SConfig.SERVER.spear_damage.get() + 0.5F * (float)EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SHARPNESS, this.spearItem);
   ...
   static {
      ...
      COLOR = SynchedEntityData.defineId(ThrownSpear.class, EntityDataSerializers.INT);
   }
}
