...
public class ThrownKnife extends AbstractArrow {
   ...
   public ThrownKnife(Level p_37569_, LivingEntity p_37570_, ItemStack stack, int color) {
      super((EntityType)Sentities.THROWN_KNIFE.get(), p_37570_, p_37569_);
      this.spearItem = new ItemStack((ItemLike)Sitems.KNIFE.get());
   ...
   public ThrownKnife(EntityType thrownSpearEntityType, Level level) {
   ...
   protected void onHitEntity(EntityHitResult hit) {
      ...
      float f = (float)(Integer)SConfig.SERVER.knife_damage.get() + 0.5F * (float)EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SHARPNESS, this.spearItem);
   ...
   static {
      ID_LOYALTY = SynchedEntityData.defineId(ThrownKnife.class, EntityDataSerializers.BYTE);
      ID_FOIL = SynchedEntityData.defineId(ThrownKnife.class, EntityDataSerializers.BOOLEAN);
      COLOR = SynchedEntityData.defineId(ThrownKnife.class, EntityDataSerializers.INT);
   }
}
